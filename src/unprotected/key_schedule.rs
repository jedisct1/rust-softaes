...
/// Multiplies two bytes in GF(2^8) (fast version, using branches).
#[inline]
...
/// Applies the inverse MixColumns transformation to a 32-bit word (one column).
#[inline]
...
#[inline]
fn inv_mix_block(block: Block) -> Block {
    Block {
